      ...
      <div class="flex flex-wrap -mx-4 lg:justify-between">
         <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
            <div class="mb-12 max-w-[570px] lg:mb-0">
               <span class="text-bold text-3xl block mb-4  font-semibold text-primary">
               Contact Us
               </span>
               <h2
               ...
               <p
                  ...
                  >
                  Help us, to upgrade overselves 🙃 by giving us your valuable feedback
                  on what you want to see next on Brigade Rush as we plan to move forward to 
                  give you the best experience you can Imagine 
                  Love you all 🥰 
               </p>
